...
* Что такое Dockerfile[^1]

* Создание Dockerfile[^2]

* Создание и запуск образа[^3]

* Код Docerfile[^4]

## Что такое Dockerfile

[^1]:Dockerfile - текстовый фаил, в котором находится инструкция по созданию образа.
...
[^2]:Задача: Копировать и запустить файл hello_world.py
...
[^3]:Инструкция готова, остаётся создать образ и проверить запустив его
...
[^4]: Вот как выглядит инструкция в целом:
